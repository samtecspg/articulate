    ...
    return (
        <aside id="side-nav">
            ...
            <ul className="primary-nav">
                <li className="btn-agent"><a href="/agents/create"><span>+ Create Agent</span></a></li>
                <li><a href="/domains/create"><img src={folder} alt=""/><span>Domains</span></a></li>
                <li><div className="divider" /></li>
                <li><a href="/intents/create"><img src={intent} alt=""/><span>Intents</span></a></li>
                <li><a href="/entities/create"><img src={entity} alt=""/><span>Entity</span></a></li>
                <li><div className="divider" /></li>
                <li><a href="/webhooks/create"><img src={webhook} alt=""/><span>Webhooks</span></a></li>
            </ul>
