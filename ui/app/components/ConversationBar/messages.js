...
export default defineMessages({
  ...
  agentFinishedTrainingTemplate: {
    ...
    defaultMessage: 'The agent <b>{agentName}</b> has finished training. {emoji}'
  },
  ...
  positiveNotificationTemplate: {
    ...
    defaultMessage: "{instanceType} <b>{instanceName}</b> {action} successfully. {emoji}"
  },
  ...
  errorCopyingSayingTemplate: {
    id: 'app.components.ConversationBar.negativeNotificationTemplate',
    defaultMessage: "There was an error copying the utterance into your sayings. Please add it manually. {emoji}"
  },
  ...
  errorCallingArticulate: {
    ...
    defaultMessage: 'I\'m sorry. An error occurred calling Articulate\'s converse service. This is not an issue with your agent. {emoji}'
  },
  ...
  errorCleaningSessionData: {
    ...
    defaultMessage: 'I\'m sorry. An error occurred cleaning your session data. {emoji}'
  },
