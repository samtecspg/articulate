...
import { Grid, Typography, Slide, Dialog, DialogContent, DialogContentText, DialogActions, Button }  from '@material-ui/core';
                ...
                <Grid className={classes.subContainer} item xs={12}>
                    <Typography className={classes.textContainer}>
                        ...
                        >
                            ...
                            <span className={classes.deleteLabel}><FormattedMessage {...messages.delete} /></span>
                        </span>
                    </Typography>
                </Grid>
            </Grid>
