          ...
          <div className="training-container">
            <div className={`status-area left ${this.props.currentAgentStatus ? (this.props.currentAgentStatus.status === 'Training' ? 'hide' : '') : ''}`}>
              <p
                ...
                <span style={{ color: this.props.currentAgentStatus ? (this.props.currentAgentStatus.status === 'Ready' ? '#00ca9f' : (this.props.currentAgentStatus.status === 'Out of Date' ? '#de5e56' : '#4e4e4e')) : '#4e4e4e'}} >
