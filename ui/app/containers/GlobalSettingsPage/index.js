...
import {
  ...
  loadGlobalSettings,
  changeGlobalSettingsData,
  resetGlobalSettingsData,
  removeGlobalSettingsFallback,
} from '../App/actions';
import {
  makeSelectError,
  makeSelectLoading,
...
export function mapDispatchToProps(dispatch) {
  return {
    ...
    onChangeGlobalSettingsData: (data, evt) => {
      ...
      dispatch(changeGlobalSettingsData(data));
    },
    onUpdate: () => {
    ...
    onComponentWillMount: () => {
      dispatch(resetGlobalSettingsData());
      dispatch(loadGlobalSettings());
    },
    onRemoveFallback: (fallbackIndex) => {
      dispatch(removeGlobalSettingsFallback(fallbackIndex));
    }
  };
}
