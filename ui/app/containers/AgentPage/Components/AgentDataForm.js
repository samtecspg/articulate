          ...
          <Grid container spacing={24} item xs={12}>
            <Grid item lg={1} md={6} sm={12} xs={12}>
              <TextField
                ...
                label=""
                onChange={evt => {
                  this.props.onChangeAgentData('gravatar', evt.target.value);
                }}
                margin="normal"
                fullWidth
                InputLabelProps={{
            ...
            <Grid item lg={4} md={12} sm={12} xs={12}>
              <TextField
                ...
                onChange={evt => {
                  this.props.onChangeAgentData('language', evt.target.value);
                }}
                margin="normal"
                fullWidth
                InputLabelProps={{
          ...
          <Grid container spacing={24} item xs={12}>
            <Grid item lg={4} md={10} sm={9} xs={8}>
              ...
              <Slider
                ...
                onChange={(evt, value) => {
                  this.props.onChangeCategoryClassifierThreshold(value);
                }}
              />
            </Grid>
