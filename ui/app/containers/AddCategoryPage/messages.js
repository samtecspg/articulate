...
export default defineMessages({
  ...
  categoryNameTextField: {
    id: 'app.containers.AddCategoryPage.component.CategoryDataForm.categoryNameTextField',
    defaultMessage: 'Category Name:',
  },
  categoryNameTextFieldPlaceholder: {
    id: 'app.containers.AddCategoryPage.component.CategoryDataForm.categoryNameTextFieldPlaceholder',
    defaultMessage: 'Your Category',
  },
  requiredField: {
    id: 'app.containers.AddCategoryPage.component.CategoryDataForm.requiredField',
  ...
  sliderActionThresholdLabel: {
    id: 'app.containers.AddCategoryPage.component.CategoryDataForm.sliderActionThresholdLabel',
    defaultMessage: 'Action Threshold',
  },
  extraTrainingData: {
    id: 'app.containers.AddCategoryPage.component.CategoryDataForm.extraTrainingData',
    defaultMessage: 'Generate extra training examples',
  },
  extraTrainingDataHelp: {
    id: 'app.containers.AddCategoryPage.component.CategoryDataForm.extraTrainingDataHelp',
  ...
  newCategoryParameterNameTextField: {
    id: 'app.containers.AddCategoryPage.component.CategoryParametersForm.newCategoryParameterNameTextField',
    defaultMessage: 'Parameter Name:',
  },
  newCategoryParameterValueTextField: {
    id: 'app.containers.AddCategoryPage.component.CategoryParametersForm.newCategoryParameterValueTextField',
    defaultMessage: 'Parameter Value:',
  },
  newCategoryParameterNameTextFieldPlaceholder: {
    id: 'app.containers.AddCategoryPage.component.CategoryParametersForm.newCategoryParameterNameTextFieldPlaceholder',
    defaultMessage: 'Type your parameter name',
  },
  newCategoryParameterValueTextFieldPlaceholder: {
    id: 'app.containers.AddCategoryPage.component.CategoryParametersForm.newCategoryParameterValueTextFieldPlaceholder',
    defaultMessage: 'Type your parameter value',
  },
  addParameter: {
    id: 'app.containers.AddCategoryPage.component.CategoryParametersForm.addParameter',
    defaultMessage: '+ Add',
  },
  createCategory: {
