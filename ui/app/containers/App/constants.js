...
export const CLOSE_TEST_TRAIN_NOTIFICATION = 'app/App/CLOSE_TEST_TRAIN_NOTIFICATION';
...
export const LOAD_AGENT_VERSIONS = 'app/AgentsPage/LOAD_AGENT_VERSIONS';
export const LOAD_AGENT_VERSIONS_SUCCESS = 'app/AgentsPage/LOAD_AGENT_VERSIONS_SUCCESS';
export const LOAD_AGENT_VERSIONS_ERROR = 'app/AgentsPage/LOAD_AGENT_VERSIONS_ERROR';
export const LOAD_AGENT_VERSION = 'app/AgentsPage/LOAD_AGENT_VERSION';
export const LOAD_AGENT_VERSION_SUCCESS = 'app/AgentsPage/LOAD_AGENT_VERSION_SUCCESS';
export const LOAD_AGENT_VERSION_ERROR = 'app/AgentsPage/LOAD_AGENT_VERSION_ERROR';
export const UPDATE_AGENT_VERSION = 'app/AgentsPage/UPDATE_AGENT_VERSION';
export const UPDATE_AGENT_VERSION_SUCCESS = 'app/AgentsPage/UPDATE_AGENT_VERSION_SUCCESS';
export const UPDATE_AGENT_VERSION_ERROR = 'app/AgentsPage/UPDATE_AGENT_VERSION_ERROR';
export const DELETE_AGENT_VERSION = 'app/AgentsPage/DELETE_AGENT_VERSION';
export const DELETE_AGENT_VERSION_SUCCESS = 'app/AgentsPage/DELETE_AGENT_VERSION_SUCCESS';
export const DELETE_AGENT_VERSION_ERROR = 'app/AgentsPage/DELETE_AGENT_VERSION_ERROR';
...
export const ADD_AGENT_VERSION = 'app/AgentPage/ADD_AGENT_VERSION';
export const ADD_AGENT_VERSION_ERROR = 'app/AgentPage/ADD_AGENT_VERSION_ERROR';
export const ADD_AGENT_VERSION_SUCCESS = 'app/AgentPage/ADD_AGENT_VERSION_SUCCESS';
...
export const TEST_AGENT_TRAIN = 'app/AgentPage/TEST_AGENT_TRAIN';
export const TEST_AGENT_TRAIN_SUCCESS = 'app/AgentPage/TEST_AGENT_TRAIN_SUCCESS';
export const TEST_AGENT_TRAIN_ERROR = 'app/AgentPage/TEST_AGENT_TRAIN_ERROR';
export const LOAD_AGENT_TRAIN_TESTS = 'app/AgentPage/LOAD_AGENT_TRAIN_TESTS';
export const LOAD_AGENT_TRAIN_TESTS_ERROR = 'app/AgentPage/LOAD_AGENT_TRAIN_TESTS_ERROR';
export const LOAD_AGENT_TRAIN_TESTS_SUCCESS = 'app/AgentPage/LOAD_AGENT_TRAIN_TESTS_SUCCESS';
export const LOAD_AGENT_TRAIN_TEST = 'app/AgentPage/LOAD_AGENT_TRAIN_TEST';
export const LOAD_AGENT_LATEST_TRAIN_TEST = 'app/AgentPage/LOAD_AGENT_LATEST_TRAIN_TEST';
export const LOAD_AGENT_LATEST_TRAIN_TEST_SUCCESS = 'app/AgentPage/LOAD_AGENT_LATEST_TRAIN_TEST_SUCCESS';
export const LOAD_AGENT_LATEST_TRAIN_TEST_ERROR = 'app/AgentPage/LOAD_AGENT_LATEST_TRAIN_TEST_ERROR';
...
export const CHANGE_AGENT_PARAMETER_NAME = 'app/AgentPage/CHANGE_AGENT_PARAMETER_NAME';
export const CHANGE_AGENT_PARAMETER_VALUE = 'app/AgentPage/CHANGE_AGENT_PARAMETER_VALUE';
...
export const LOAD_LOGS_ERROR = 'app/AgentPage/LOAD_LOGS_ERROR';
export const LOAD_LOGS_SUCCESS = 'app/AgentPage/LOAD_LOGS_SUCCESS';
export const DELETE_DOCUMENT = 'app/AgentPage/DELETE_DOCUMENT';
export const DELETE_DOCUMENT_ERROR = 'app/AgentPage/DELETE_DOCUMENT_ERROR';
export const DELETE_SESSION_DATA = 'app/AgentPage/DELETE_SESSION_DATA';
export const DELETE_SESSION_DATA_ERROR = 'app/AgentPage/DELETE_SESSION_DATA_ERROR';
export const LOAD_AGENT_STATS = 'app/AgentPage/LOAD_AGENT_STATS';
export const LOAD_AGENT_STATS_ERROR = 'app/AgentPage/LOAD_AGENT_STATS_ERROR';
...
export const LOAD_FILTERED_ACTIONS_ERROR = 'app/SayingsPage/LOAD_FILTERED_ACTIONS_ERROR';
export const LOAD_FILTERED_ACTIONS_SUCCESS = 'app/SayingsPage/LOAD_FILTERED_ACTIONS_SUCCESS';
...
export const EDIT_TEXT_RESPONSE_FLAG = 'app/ActionPage/EDIT_TEXT_RESPONSE_FLAG';
...
export const REFRESH_KEYWORD_EXAMPLE_UPDATE = 'app/KeywordsEditPage/REFRESH_KEYWORD_EXAMPLE_UPDATE';
export const RECOGNIZE_UPDATED_KEYWORDS = 'app/KeywordsEditPage/RECOGNIZE_UPDATED_KEYWORDS';
...
export const DELETE_CATEGORY_PARAMETER = 'app/AgentPage/DELETE_CATEGORY_PARAMETER';
export const CHANGE_CATEGORY_PARAMETER_NAME = 'app/AgentPage/CHANGE_CATEGORY_PARAMETER_NAME';
export const CHANGE_CATEGORY_PARAMETER_VALUE = 'app/AgentPage/CHANGE_CATEGORY_PARAMETER_VALUE';
export const LOAD_PREBUILT_CATEGORIES = 'app/CategoryPage/LOAD_PREBUILT_CATEGORIES';
export const LOAD_PREBUILT_CATEGORIES_ERROR = 'app/CategoryPage/LOAD_PREBUILT_CATEGORIES_ERROR';
export const LOAD_PREBUILT_CATEGORIES_SUCCESS = 'app/CategoryPage/LOAD_PREBUILT_CATEGORIES_SUCCESS';
...
export const IMPORT_CATEGORY_SUCCESS = 'app/CategoryPage/IMPORT_CATEGORY_SUCCESS';
...
export const LOAD_CURRENT_USER = 'app/user/LOAD_CURRENT_USER';
...
export const LOAD_ACCESS_CONTROL_ERROR = 'app/SettingsPage/LOAD_ACCESS_CONTROL_ERROR';
export const LOAD_ACCESS_CONTROL_SUCCESS = 'app/SettingsPage/LOAD_ACCESS_CONTROL_SUCCESS';
export const CHANGE_ACCESS_CONTROL_DATA = 'app/SettingsPage/CHANGE_ACCESS_CONTROL_DATA';
export const UPDATE_ACCESS_CONTROL = 'app/SettingsPage/UPDATE_ACCESS_CONTROL';
export const UPDATE_ACCESS_CONTROL_ERROR = 'app/SettingsPage/UPDATE_ACCESS_CONTROL_ERROR';
export const UPDATE_ACCESS_CONTROL_SUCCESS = 'app/SettingsPage/UPDATE_ACCESS_CONTROL_SUCCESS';
export const REMOVE_ACCESS_CONTROL = 'app/SettingsPage/REMOVE_ACCESS_CONTROL';
export const REMOVE_ACCESS_CONTROL_ERROR = 'app/SettingsPage/REMOVE_ACCESS_CONTROL_ERROR';
export const REMOVE_ACCESS_CONTROL_SUCCESS = 'app/SettingsPage/REMOVE_ACCESS_CONTROL_SUCCESS';
export const ADD_ACCESS_CONTROL = 'app/SettingsPage/ADD_ACCESS_CONTROL';
export const ADD_ACCESS_CONTROL_ERROR = 'app/SettingsPage/ADD_ACCESS_CONTROL_ERROR';
export const ADD_ACCESS_CONTROL_SUCCESS = 'app/SettingsPage/ADD_ACCESS_CONTROL_SUCCESS';

/*Filters Dialogue Page*/
export const CHANGE_DIALOGUE_PAGE_FILTER_SEARCH_SAYING = 'app/DialoguePage/CHANGE_DIALOGUE_PAGE_FILTER_SEARCH_SAYING';
export const CHANGE_DIALOGUE_PAGE_FILTER_CATEGORY = 'app/DialoguePage/CHANGE_DIALOGUE_PAGE_FILTER_CATEGORY';
export const CHANGE_DIALOGUE_PAGE_FILTER_ACTIONS = 'app/DialoguePage/CHANGE_DIALOGUE_PAGE_FILTER_ACTIONS';
export const CHANGE_DIALOGUE_PAGE_NUMBER_OF_FILTERS_APPLIED = 'app/DialoguePage/CHANGE_DIALOGUE_PAGE_NUMBER_OF_FILTERS_APPLIED';
export const CHANGE_DIALOGUE_PAGE_FILTER_STRING = 'app/DialoguePage/CHANGE_DIALOGUE_PAGE_FILTER_STRING';
export const RESET_DIALOGUE_PAGE_FILTERS = 'app/DialoguePage/RESET_DIALOGUE_PAGE_FILTERS';
export const CHANGE_DIALOGUE_PAGE_FILTER_KEYWORDS = 'app/DialoguePage/CHANGE_DIALOGUE_PAGE_FILTER_KEYWORDS';
export const CHANGE_DIALOGUE_PAGE_FILTER_ACTION_ISSUES = 'app/DialoguePage/CHANGE_DIALOGUE_PAGE_FILTER_ACTION_ISSUES';
export const CHANGE_DIALOGUE_PAGE_FILTER_KEYWORD_ISSUES = 'app/DialoguePage/CHANGE_DIALOGUE_PAGE_FILTER_KEYWORD_ISSUES';

/*Filters Review  Page*/
export const CHANGE_REVIEW_PAGE_FILTER_SEARCH_SAYING = 'app/DialoguePage/CHANGE_REVIEW_PAGE_FILTER_SEARCH_SAYING';
export const CHANGE_REVIEW_PAGE_FILTER_CATEGORY = 'app/DialoguePage/CHANGE_REVIEW_PAGE_FILTER_CATEGORY';
export const CHANGE_REVIEW_PAGE_FILTER_ACTIONS = 'app/DialoguePage/CHANGE_REVIEW_PAGE_FILTER_ACTIONS';
export const CHANGE_REVIEW_PAGE_NUMBER_OF_FILTERS_APPLIED = 'app/DialoguePage/CHANGE_REVIEW_PAGE_NUMBER_OF_FILTERS_APPLIED';
export const CHANGE_REVIEW_PAGE_FILTER_STRING = 'app/DialoguePage/CHANGE_REVIEW_PAGE_FILTER_STRING';
export const CHANGE_REVIEW_PAGE_FILTER_ACTION_INTERVAL_MIN = 'app/DialoguePage/CHANGE_REVIEW_PAGE_FILTER_ACTION_INTERVAL_MIN';
export const CHANGE_REVIEW_PAGE_FILTER_ACTION_INTERVAL_MAX = 'app/DialoguePage/CHANGE_REVIEW_PAGE_FILTER_ACTION_INTERVAL_MAX';
export const RESET_REVIEW_PAGE_FILTERS = 'appDialoguePage/RESET_REVIEW_PAGE_FILTERS';

export const CHANGE_REVIEW_PAGE_FILTER_CONTAINERS = 'app/DialoguePage/CHANGE_REVIEW_PAGE_FILTER_CONTAINERS';
export const CHANGE_REVIEW_PAGE_FILTER_MAX_LOGS = 'app/DialoguePage/CHANGE_REVIEW_PAGE_FILTER_MAX_LOGS';
export const CHANGE_REVIEW_PAGE_LOGS_NUMBER_OF_FILTERS_APPLIED = 'app/DialoguePage/CHANGE_REVIEW_PAGE_LOGS_NUMBER_OF_FILTERS_APPLIED';
export const CHANGE_REVIEW_PAGE_FILTER_LOGS_STRING = 'app/DialoguePage/CHANGE_REVIEW_PAGE_FILTER_LOGS_STRING';
export const RESET_REVIEW_PAGE_LOGS_FILTERS = 'app/DialoguePage/RESET_REVIEW_PAGE_LOGS_FILTERS';
