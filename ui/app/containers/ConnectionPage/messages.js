/*
 * ConnectionsEditPage Messages
 *
 * This contains all the text for the ConnectionsEditPage component.
 */
...
export default defineMessages({
  createSubtitle: {
    id: 'app.containers.ConnectionsEditPage.createSubtitle',
    defaultMessage: 'Create',
  },
  instanceName: {
    id: 'app.containers.ConnectionsEditPage.instanceName',
  ...
  help: {
    id: 'app.containers.ConnectionsEditPage.help',
    defaultMessage: 'Help?',
  },
  ...
  details: {
    id: 'app.containers.ConnectionsEditPage.component.MainTab.values',
    defaultMessage: 'Details',
  },
  modifiers: {
    id: 'app.containers.ConnectionsEditPage.component.MainTab.modifiers',
    defaultMessage: 'Modifiers',
  },
  backButton: {
    id: 'app.containers.ConnectionsEditPage.backButton',
    defaultMessage: 'Exit',
  },
  finishButton: {
    id: 'app.containers.ConnectionsEditPage.component.MainTab.finishButton',
    defaultMessage: 'Save',
  },
  nextButton: {
    id: 'app.containers.ConnectionsEditPage.component.MainTab.nextButton',
    defaultMessage: 'Next >',
  },
  valuesFormTitle: {
