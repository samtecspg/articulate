      ...
      <Grid item xs={12}>
        <Grid className={classes.formContainer} container item xs={12}>
          <Grid
            ...
            xs={12}
          >
            {Object.keys(category.parameters).map(
              (parameter, parameterIndex) => (
                ...
                >
                  <Grid
                    className={classes.categoryParameterInputContainer}
                    item
                    xs={6}
                  >
                    <TextField
                      ...
                      className={
                        parameterIndex !== 0
                          ? classes.categoryParameterInput
                          : ''
                      }
                      value={parameter}
                      label={
                        parameterIndex === 0
                          ? intl.formatMessage(
                              messages.newCategoryParameterNameTextField,
                            )
                          : null
                      }
                      placeholder={intl.formatMessage(
                        messages.newCategoryParameterNameTextFieldPlaceholder,
                      )}
                      onChange={evt => {
                  ...
                  >
                    <TextField
                      ...
                      label={
                        parameterIndex === 0
                          ? intl.formatMessage(
                              messages.newCategoryParameterValueTextField,
                            )
                          : null
                      }
                      placeholder={intl.formatMessage(
                        messages.newCategoryParameterValueTextFieldPlaceholder,
                      )}
                      onChange={evt => {
