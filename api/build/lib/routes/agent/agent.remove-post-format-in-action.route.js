...
module.exports = {
  ...
  options: {
    tags: ['api'],
    validate: _agent.default.removePostFormatInAction,
    handler: async (request, h) => {
      ...
      try {
        await agentService.removePostFormatInAction({
          id: agentId,
          actionId
        });
        return h.continue;
...
//# sourceMappingURL=agent.remove-post-format-in-action.route.js.map