...
module.exports = {
  method: 'post',
  path: `/${_constants.ROUTE_AGENT}/{${_constants.PARAM_AGENT_ID}}/${_constants.ROUTE_KEYWORD}`,
  options: {
    tags: ['api'],
    validate: _agent.default.createKeyword,
    handler: async request => {
      ...
      try {
        return await agentService.createKeyword({
          id,
...
//# sourceMappingURL=agent.create-keyword.route.js.map