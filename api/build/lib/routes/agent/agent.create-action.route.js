...
module.exports = {
  method: ['post'],
  path: `/${_constants.ROUTE_AGENT}/{${_constants.PARAM_AGENT_ID}}/${_constants.ROUTE_ACTION}`,
  options: {
    tags: ['api'],
    validate: _agent.default.createAction,
    handler: async request => {
      ...
      try {
        return await agentService.createAction({
          id,
          actionId: null,
...
//# sourceMappingURL=agent.create-action.route.js.map